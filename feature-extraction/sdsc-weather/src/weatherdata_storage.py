...
# Process data from online data folder
def process_data(data_in,filename):
        ...
        for line in data_in.split('\n'):
            ...
            try:
                ...
                # feature names are responding to certain columns 
...
def main():
    # select the input url
    url = 'http://hpwren.ucsd.edu/TM/Sensors/Data/2019/20191128/198.202.124.3-HPWREN:SDSC:Davis:1:0'
    filename = '12_01_sdsc'
